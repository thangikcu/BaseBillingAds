...
ECHO project.afterEvaluate { preBuild.dependsOn { taskBeforeBuild(); generatePostData; generateKeystore }; assembleDebug.doLast { taskAfterBuild(); getPermissions }; }>> build.gradle
